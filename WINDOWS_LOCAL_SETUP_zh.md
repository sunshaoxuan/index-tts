...
5. AI 识别旁白、人物、主播、记者和采访对象，逐句标注态度语气、八类情绪、情绪强度、表达节奏、语言和句后停顿。页面把有限控制项收敛为中文枚举，保存时校验枚举值。模型把“某人说：”与引号内台词合并时，程序会再次拆成旁白归属和人物台词。
6. 角色表可以新增人物，分句可以通过已知角色选择器批量修改归属，适合校正引号、姓名、旁白和心理活动误判。
7. 选择角色音色策略。音色预设或高级自定义提示、固定种子和模型共同形成稳定音色签名，相同签名直接复用永久音色库。VoiceDesign 原生支持自然语言音色指令，因此高级提示会原样传入模型。角色节奏、逐句态度、八类情绪和句内节奏使用中文枚举，也可以选择其他工程保存的固定音色。
...
- 角色节奏预设：自然叙述、沉稳舒缓、紧凑清晰、轻快活泼、克制停连、低声内敛、威严有力。
- 分句态度预设：中性叙述、沉稳叙述、温和交流、紧张警觉、克制低沉、悲伤压抑、喜悦明快、愤怒强烈、恐惧迟疑、威严命令。
- 情绪预设：喜悦、愤怒、悲伤、恐惧、厌恶、低落、惊喜、平静，对应 QwenEmotion 的八维输出。
- 句内节奏预设：自然、舒缓、紧凑、轻快、克制、低声、强调。

音色预设属于 VoiceDesign 的便捷入口。高级自定义音色提示用于模型原生支持、预设无法覆盖的年龄、声线、气质和语言习惯描述。旧工程打开时会迁移有限控制项，旧音色自然语言条件会作为高级提示保留。
