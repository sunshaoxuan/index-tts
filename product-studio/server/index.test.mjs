...
test('normalizes per character voice controls and invalidates only the affected role', async () => {
  ...
  project.character_assets.narrator.voice_candidates = [{ voice_id: 'voice-verified', seed: 77, median_pitch_hz: 218.5, selected: true, gender_verified: true, age_band_verified: true, gender_identity_verified: true, gender_identity_method: 'human_listening' }];
  ...
  assert.deepEqual(saved.json().character_assets.narrator.voice_candidates, [{ voice_id: 'voice-verified', seed: 77, median_pitch_hz: 218.5, selected: true, gender_verified: true, age_band_verified: true, gender_identity_verified: true, gender_identity_method: 'human_listening' }]);
  await app.close();
});
