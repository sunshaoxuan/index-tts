...
Windows 本地源码运行可参考 [Windows 本地运行说明](../WINDOWS_LOCAL_SETUP_zh.md)。
...
浏览器访问 `http://127.0.0.1:7864`。产品界面采用 React 19 和 Ant Design 6，
Node.js 24 提供 API，Python Worker 负责 AI 分析、音色设计和音频合成。
