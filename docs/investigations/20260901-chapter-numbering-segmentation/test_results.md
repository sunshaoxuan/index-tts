...
| Docker 运行验收 | passed | 当前镜像 `indextts25-product-studio:1.1.51-705fd39`，running，healthy，RestartCount 0 |
...
| 当前生产镜像重载复核 | passed | 在 `1.1.51-705fd39` 重新加载白夜行03，第一页 20 行仍为“第 1 章”，Console 0 error |
